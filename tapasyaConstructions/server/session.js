...
// KV-backed session, one entry per visitor keyed by a random id in an httpOnly
// cookie. Route handlers read/write c.get('session') directly; this middleware
// loads it before the handler runs and persists it after.
